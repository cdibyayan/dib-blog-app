                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="container p-4">
                            <div class="row">
                              <div class="col-12">
                                <h2 class="float-left">List / Grid Layout</h2>
                              ...
                              <div class="item col-12 mb-3">
                                <div class="card rounded shadow border-0">
                                  <a href="{{ route('posts.view', $post->slug) }}">
                                    <img class="w-100 d-none" style="height: 300px; object-fit: cover; border-top-right-radius: 5px; border-top-left-radius: 5px;" src="{{ asset('storage/' . $post->thumbnail) }}" alt="" />
                                  </a>
                                  <div class="card-body p-3">
                                    <a href="#" class="text-dark">
                                      <h4>{{ $post->title }}</h4>
                                    </a>
                                    <p class="text-muted small">By {{ $post->user->name }}  on {{ $post->created_at->format('Y-m-d H:i:s') }}</p>
                                    <p>{{ \Illuminate\Support\Str::limit(strip_tags($post->content), 50) }}</p>
                                    <a class="btn btn-dark" href="{{ route('posts.view', $post->slug) }}">Read more</a>
                                  </div>
                                </div>
                              </div>
                              @endforeach
